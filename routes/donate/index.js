...
module.exports = (router, url) => {
    ...
    router.get(url + '.html', (req, res, next) => {
      var site = { url: req.originalUrl, title: '捐赠我们', keywords: 'express,nodejs,less,html5,css3,webpack,jquery,lazyload', description: 'https://github.com/womendi/express-multipage.git', path: global.path };
      var indexData = {
